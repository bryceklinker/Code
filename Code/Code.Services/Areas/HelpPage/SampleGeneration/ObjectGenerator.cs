...
namespace Code.Services.Areas.HelpPage.SampleGeneration
{
    ...
    public class ObjectGenerator
    {
        ...
        private static object GenerateGenericType(
            Type type, int collectionSize, Dictionary<Type, object> createdObjectReferences)
        {
        ...
        private static object GenerateKeyValuePair(
            Type keyValuePairType, Dictionary<Type, object> createdObjectReferences)
        {
        ...
        private static object GenerateDictionary(
            Type dictionaryType, int size, Dictionary<Type, object> createdObjectReferences)
        {
            ...
            for (var i = 0; i < size; i++)
            {
                ...
                var containsKey = (bool) containsMethod.Invoke(
                    result,
                    new[]
                    {
                        newKey
        ...
        private static object GenerateQueryable(
            Type queryableType, int size, Dictionary<Type, object> createdObjectReferences)
        {
            ...
            if (isGeneric)
            {
                ...
                return asQueryableMethod.Invoke(
                    null,
                    new[]
                    {
                        list
        ...
        private static object GenerateCollection(
            Type collectionType, int size, Dictionary<Type, object> createdObjectReferences)
        {
